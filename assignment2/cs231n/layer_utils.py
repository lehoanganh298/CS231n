...
def affine_bn_relu_backward(dout, cache):
  ...
  bn_dx, bn_dgamma, bn_dbeta = batchnorm_backward_alt(relu_dx, bn_cache)
  affine_dx, affine_dw, affine_db = affine_backward(bn_dx, affine_cache)

  return affine_dx, affine_dw, affine_db, bn_dgamma, bn_dbeta
